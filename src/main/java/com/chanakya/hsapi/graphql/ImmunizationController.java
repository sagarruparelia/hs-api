...
import com.chanakya.hsapi.graphql.transform.ImmunizationTransform;
...
public class ImmunizationController {
    ...
    private final ImmunizationTransform transform;
    private final AuditService auditService;
    private final HttpServletRequest request;

    public ImmunizationController(PatientCrosswalkService crosswalk, FhirClient fhirClient,
                                   ImmunizationTransform transform, AuditService auditService,
    ...
    @QueryMapping
    public List<ImmunizationType> immunizations(@Argument String enterpriseId,
